...
export const TabsProfile: React.FC<Props> = ({ className }) => {
  ...
  return (
    ...
    >
      <TabsList className="flex w-[320px] flex-col gap-5 py-3 items-start rounded border border-[#E9EAEE] relative max-lg:w-full max-lg:flex-row max-lg:overflow-auto max-lg:scrollbar max-lg:gap-10 max-lg:ml-2">
        <TabsTrigger
          value="account"
          className={`${
            isMedia1024
