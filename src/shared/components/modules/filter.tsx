...
import {FilterSkeleton} from "@/shared/components/elements";
    ...
    return (
        <>
            {isClient ? (
                <div className={cn("relative", !isMedia768 && className)}>
                    {isMedia768 ? (
                        <div className="flex items-start justify-between gap-2">
                            <CategoryFilter
                                className="w-[50%] pt-4  border-[2px] border-[#E6E7EB] rounded-[6px]"
                            ...
                            <Sheet>
                                <SheetTrigger asChild>
                                    <Button
                                        className="flex items-center justify-between relative w-[50%] border-[2px] border-[#E6E7EB] rounded-[6px]  py-4 text-[14px] text-black font-black h-[70px] "
                                        variant="outline"
                                    >
                                        <span>ФИЛЬТРЫ</span>
                                    </Button>
                ...
                <FilterSkeleton isMedia={isMedia768}/>
